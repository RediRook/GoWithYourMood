...
{
    document.getElementById ("searchAnxious").addEventListener ("click", function(){mapRedirect(1);});
    document.getElementById ("searchSad").addEventListener ("click", function(){mapRedirect(2);});
    document.getElementById ("searchIsolated").addEventListener ("click", function(){mapRedirect(3);});
    document.getElementById ("searchUnsafe").addEventListener ("click", function(){mapRedirect(4);});   
    
    document.getElementById ("btnAnxious").addEventListener ("click", function(){switchVisibleStatistics(1);});
    document.getElementById ("btnSad").addEventListener ("click", function(){switchVisibleStatistics(2);});
    document.getElementById ("btnIsolated").addEventListener ("click", function(){switchVisibleStatistics(3);});
    document.getElementById ("btnUnsafe").addEventListener ("click", function(){switchVisibleStatistics(4);});     
        
    document.getElementById ("txtAnxious").addEventListener ("click", function(){switchVisibleStatistics(1);});
    document.getElementById ("txtSad").addEventListener ("click", function(){switchVisibleStatistics(2);});
    document.getElementById ("txtIsolated").addEventListener ("click", function(){switchVisibleStatistics(3);});
    document.getElementById ("txtUnsafe").addEventListener ("click", function(){switchVisibleStatistics(4);}); 
}
